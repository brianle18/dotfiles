...
-- Use <leader>y to trigger inlay type hints
keyset("n", "<leader>y", ":CocCommand document.toggleInlayHint<CR>")
...
-- o.statusline:prepend("%{coc#status()}%{get(b:,'coc_current_function','')}")
